...
10. daily_overview 是整份日报最重要的内容。必须把当天收集的信息综合成一段连贯中文，不要编号、列表或分段，控制在 180-260 字。依次说明：哪些国家或地区发生了什么重要事件；科技、AI、经济、政治、医学健康分别出现了什么变化；这些事件共同反映出什么趋势；可能怎样影响普通人的工作、收入、物价、医疗和日常生活。只根据输入信息总结，不要逐条复述新闻，不要堆砌标题，不要编造没有的信息。11. 极度精简内容：tech_briefs 只保留 2-3 条，finance_briefs 只保留 2 条，politics_briefs 只保留 1-2 条。宁缺毋滥，不要为了凑数量保留低价值新闻。
